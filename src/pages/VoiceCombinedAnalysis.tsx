...
const VoiceAnalysis = () => {
  ...
  const analyzeVoice = async () => {
    ...
    try {
      ...
      localStorage.setItem("analysis_type", "voice");
    ...
    <div className="min-h-screen bg-[#f8f6ff] px-6 py-10">
      <div className="mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow">
        ...
        <p className="mt-3 text-gray-600">
          ...
          indicators. It does not diagnose depression. After analysis, you will
          be redirected to self-assessment for the final combined result.
        </p>
        ...
        <div className="mt-8 rounded-2xl border bg-gray-50 p-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Speak clearly for 5 to 10 seconds. Example: “I am feeling stressed
            about my exams and assignments.”
          </p>
        ...
        {result && (
          <div className="mt-8 rounded-2xl border bg-purple-50 p-6">
            ...
            <div className="mt-4 space-y-2 text-gray-800">
              ...
              <p>
                <strong>Wellbeing Cue:</strong> {result.wellbeing_cue}
              </p>
              ...
              <p>
                <strong>Voice Score:</strong> {result.voice_score}
              </p>
            </div>

            <div className="mt-5 rounded-xl bg-white p-4 text-sm text-gray-700 border">
              Voice analysis completed successfully. Redirecting to self
              assessment...
            </div>
          </div>
        )}
