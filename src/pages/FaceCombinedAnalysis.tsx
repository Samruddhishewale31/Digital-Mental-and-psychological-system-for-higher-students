...
export default function FaceAnalysis() {
  ...
  const analyzeFace = async () => {
    ...
    try {
      ...
      // SAVE DATA FOR COMBINED RESULT
      localStorage.setItem("analysis_type", "face");
      ...
      // AUTO REDIRECT TO SELF ASSESSMENT
      setTimeout(() => {
        navigate("/assessment");
      }, 2500);
    ...
    <div className="min-h-screen bg-[#f8f6ff] px-6 py-10">
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow">
        ...
        <p className="mt-3 text-gray-600">
          ...
          disgust. It does not diagnose depression. It only
          provides an emotional cue score for wellbeing
          support.
        </p>
        ...
        {result && (
          <div className="mt-8 rounded-2xl border bg-purple-50 p-6">
            ...
            <div className="mt-4 space-y-2 text-gray-800">
              ...
              <p>
                <strong>Face Score:</strong>{" "}
                {result.face_score}
              </p>
            </div>

            <div className="mt-5 rounded-xl bg-white p-4 text-sm text-gray-700 border">
              Face analysis completed successfully.
              Redirecting to self assessment...
            </div>

            <p className="mt-4 text-sm text-gray-600">
              Face emotional cues will be combined with
              self-assessment responses to generate the final
              emotional wellbeing result.
            </p>
          </div>
        )}
      </div>
