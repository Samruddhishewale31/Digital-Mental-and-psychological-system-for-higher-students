...
export default function FaceCombineAnalysis() {
  ...
  const captureImage = () => {
    ...
    if (!imageSrc) {
      ...
      alert(
        "Unable to capture image. Please allow camera permission."
      );
  ...
  const analyzeFace = async () => {
    ...
    try {
      ...
      // =================================
      // SAVE FACE DATA FOR FINAL COMBINE
      // =================================
      ...
      alert(
        "Something went wrong while analyzing face."
      );
    ...
    <div className="min-h-screen bg-[#f8f6ff] px-6 py-10">
      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow">
        ...
        <p className="mt-3 text-gray-600">
          ...
          This module analyzes facial emotional cues such as
          neutral, happy, sad, angry, fear, surprise, and
          disgust. The result is combined with voice analysis
          and self assessment responses for wellbeing support.
        ...
        {result && (
          ...
          <div className="mt-8 rounded-2xl border bg-purple-50 p-6">
            ...
            <div className="mt-5 rounded-xl bg-white p-4 border text-sm text-gray-700">
              ...
              Combining face + voice + self assessment data.
